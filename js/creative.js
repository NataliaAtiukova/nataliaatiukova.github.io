...
const translations = {
  ru: {
    ...
    header: {
      ...
      desc: 'Я — Атюкова Наталья Владимировна — мобильный разработчик, создающий современные и удобные приложения для iOS и Android. Использую современные инструменты — Swift, SwiftUI, Kotlin, Firebase — чтобы разрабатывать мощные кроссплатформенные решения. Ознакомьтесь с моими проектами ниже или посетите мой GitHub!',
      btn: 'Подробнее',
    },
    // ... другие секции ...
  },
